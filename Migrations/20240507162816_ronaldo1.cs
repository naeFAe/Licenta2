...
{
    /// <inheritdoc />
    public partial class ronaldo1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmpImageData = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentsServices", x => x.AppointmentServicesId);
                    table.ForeignKey(
                        name: "FK_AppointmentsServices_AspNetUsers_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_AppointmentsServices_ServicesId",
                        column: x => x.ServicesId,
                        principalTable: "AppointmentsServices",
                        principalColumn: "AppointmentServicesId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SeriviceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AppointmentsServices_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Weeks_AppointmentsServices_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "AppointmentsServices",
                        principalColumn: "AppointmentServicesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Appointments_AppointmentsID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentsServices_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_AppointmentsID",
                table: "Payments",
